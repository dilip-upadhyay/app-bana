...
public class AppBanaSchemaLoader {
    ...
    private void addFieldType(String name, String description, String htmlType,
        ...
        schema.setMetadata(new HashMap<>(config));
        schema.getMetadata().put("htmlType", htmlType);
    ...
    private void loadComponentSchemas() {
        ...
        addComponentSchema("input", "Text input field",
                Map.of(
                        ...
                        "type", prop("string", "Input type (text, email, number, etc.)", false, "text"),
        ...
        addComponentSchema("button", "Action button",
                Map.of(
                        ...
                        "actionType", prop("string", "Action type: save-entity, navigate, api", false),
                        "entities", prop("array", "Entities to save (for save-entity action)", false),
        ...
        addComponentSchema("container", "Container for grouping components",
                Map.of(
                        ...
                        "layout", prop("string", "Layout direction: row, column", false, "column"),
