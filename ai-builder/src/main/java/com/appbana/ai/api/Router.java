...
public class Router {
    ...
    public Router get(String path, BiConsumer<HttpRequest, HttpResponse> h) {
        routes.add(new Route("GET", path, h));
        return this;
    }

    public Router post(String path, BiConsumer<HttpRequest, HttpResponse> h) {
        routes.add(new Route("POST", path, h));
        return this;
    }

    public Router put(String path, BiConsumer<HttpRequest, HttpResponse> h) {
        routes.add(new Route("PUT", path, h));
        return this;
    }

    public Router delete(String path, BiConsumer<HttpRequest, HttpResponse> h) {
        routes.add(new Route("DELETE", path, h));
        return this;
    }
    ...
    public void handle(HttpExchange ex) throws IOException {
        ...
        headers.add("Access-Control-Allow-Headers",
                "Content-Type, Authorization, X-Session-Token, X-Session-Id, X-CSRF-Token");
    ...
    // New: servlet-based handle for use with embedded containers (Tomcat, Jetty,
    // etc.)
    ...
    private static void sendError(HttpExchange exchange, int status, String msg) throws IOException {
        ...
        byte[] b = ("{\"error\":\"" + (msg == null ? "" : msg.replace('"', '\'')) + "\"}")
    ...
    public static class HttpRequest {
        ...
        public HttpRequest(HttpExchange ex, Map<String, String> pathParams, Map<String, String> query) {
            this.ex = ex;
    ...
    public static class HttpResponseServlet extends HttpResponse {
        ...
        public HttpResponseServlet(HttpServletResponse resp) {
            super(null);
            this.resp = resp;
        }
