...
| **B — Complex UI Epic** | 5 sub-phases (B1..B5): wizards · conditional fields · file upload (backend included) · master-detail · list views (filter/group/saved views) | [COMPLEX_UI_PLAN.md](./planning/COMPLEX_UI_PLAN.md) | ✅ Complete 2026-07-28 — B1 wizards (`8efc539`), B2 conditional fields (`e8a9c9a`), B3 file upload (`dd84257`), B4 master-detail (`60a64aa`), B5 list views + saved views (`4ce56d0`). All five phases: mvn compile clean · tsc clean · vitest 135/135. |
