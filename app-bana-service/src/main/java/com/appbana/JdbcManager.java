    ...
    public static void ensureMetaTableFor(String datasourceName) {
        ...
        switch (dialect) {
            case "postgres":
                ...
                auditSql = "CREATE TABLE IF NOT EXISTS appbana_audit (id BIGSERIAL PRIMARY KEY, ts TIMESTAMPTZ DEFAULT CURRENT_TIMESTAMP, op VARCHAR(20), entity VARCHAR(200), pk VARCHAR(200), actor VARCHAR(200), before_json TEXT, after_json TEXT, changes_json TEXT, tenant_id VARCHAR(200), app_id VARCHAR(200))";
                break;
            case "mysql":
            case "mariadb":
                schemasSql = "CREATE TABLE IF NOT EXISTS appbana_schemas (name VARCHAR(200) PRIMARY KEY, json TEXT)";
                ...
                auditSql = "CREATE TABLE IF NOT EXISTS appbana_audit (id BIGINT AUTO_INCREMENT PRIMARY KEY, ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP, op VARCHAR(20), entity VARCHAR(200), pk VARCHAR(200), actor VARCHAR(200), before_json TEXT, after_json TEXT, changes_json TEXT, tenant_id VARCHAR(200), app_id VARCHAR(200))";
                break;
            case "sqlite":
                ...
                auditSql = "CREATE TABLE IF NOT EXISTS appbana_audit (id INTEGER PRIMARY KEY AUTOINCREMENT, ts DATETIME DEFAULT CURRENT_TIMESTAMP, op TEXT, entity TEXT, pk TEXT, actor TEXT, before_json TEXT, after_json TEXT, changes_json TEXT, tenant_id TEXT, app_id TEXT)";
                break;
            case "mssql":
                ...
                auditSql = "CREATE TABLE IF NOT EXISTS appbana_audit (id BIGINT IDENTITY(1,1) PRIMARY KEY, ts DATETIME2 DEFAULT SYSDATETIME(), op NVARCHAR(20), entity NVARCHAR(200), pk NVARCHAR(200), actor NVARCHAR(200), before_json NVARCHAR(MAX), after_json NVARCHAR(MAX), changes_json NVARCHAR(MAX), tenant_id NVARCHAR(200), app_id NVARCHAR(200))";
                break;
            case "oracle":
                ...
                auditSql = "BEGIN EXECUTE IMMEDIATE 'CREATE TABLE appbana_audit (id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, ts TIMESTAMP DEFAULT SYSTIMESTAMP, op VARCHAR2(20), entity VARCHAR2(200), pk VARCHAR2(200), actor VARCHAR2(200), before_json CLOB, after_json CLOB, changes_json CLOB, tenant_id VARCHAR2(200), app_id VARCHAR2(200))'; EXCEPTION WHEN OTHERS THEN IF SQLCODE != -955 THEN RAISE; END IF; END;";
                break;
            case "h2":
            default:
                ...
                auditSql = "CREATE TABLE IF NOT EXISTS appbana_audit (id IDENTITY PRIMARY KEY, ts TIMESTAMP DEFAULT CURRENT_TIMESTAMP, op VARCHAR(20), entity VARCHAR(200), pk VARCHAR(200), actor VARCHAR(200), before_json CLOB, after_json CLOB, changes_json CLOB, tenant_id VARCHAR(200), app_id VARCHAR(200))";
                break;
        }
